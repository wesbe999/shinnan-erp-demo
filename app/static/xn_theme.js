  ...
  function injectStyle() {
    ...
    if (t.heroBg) {
      css.push(
        ...
        "html,body{background:"+t.f+"!important;font-family:'LXGW WenKai TC','FangSong','Microsoft JhengHei',serif!important}",
        ...
        ":root:root .brand-zh::before{content:''!important;display:inline-block!important;width:72px!important;height:72px!important;background:url('/erp-static/shinnan_home_logo.png') center/contain no-repeat!important;flex-shrink:0!important}",
        ...
        ":root:root .footer{bottom:22px!important;font-size:13px!important}",
        ...
        ":root:root .mi{width:27px!important;height:24px!important;margin-bottom:4px!important}",
        ":root:root .mi svg{width:24px!important;height:24px!important}",
