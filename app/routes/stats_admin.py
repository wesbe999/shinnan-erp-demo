...
@media(max-width:560px){.page{width:min(100% - 22px,1480px)}.kpi-grid{grid-template-columns:1fr}.bar-row{grid-template-columns:110px 1fr 58px}.intro{display:block}.actions{margin-top:12px}}
</style>
</head>
<body>
