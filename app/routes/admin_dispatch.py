...
<section class="web-title web-title-tech" id="xn-page-header">
  ...
  <div class="xn-header-actions">
    <button type="button" style="background:#1a6b3a !important;border:1.5px solid #d4af37 !important" onclick="openCreateModal()">＋ 新增案件</button>
    <button type="button" style="background:#b45309 !important;border:1.5px solid #d4af37 !important" onclick="loadAll()">重新整理</button>
    ...
    <button type="button" class="danger" style="border:1.5px solid #d4af37 !important" onclick="logout()">登出</button>
  </div>
</section>
