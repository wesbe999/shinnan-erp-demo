...
BUILDING_NAMES_BY_AREA: dict[str, list[str]] = {
    ...
    "南高": ["鳳山首府", "五甲名邸", "前鎮華廈", "瑞隆新城", "草衙世家", "小港天廈", "桂林雅築", "鳳新御品", "南高花園", "鳳凰大樓"],
    "北高": ["左營首府", "巨蛋名邸", "博愛華廈", "明誠天廈", "自由世家", "河堤雅苑", "鼎山花園", "高鐵新城", "北高御品", "文自大樓"],
    "透天": ["府城透天", "東門透天", "文化透天", "長榮透天", "安南透天", "仁德透天", "永康透天", "安平透天", "南高透天", "北高透天"],
}
